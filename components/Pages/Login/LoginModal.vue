  ...
  >
    ...
    <div class="form-group">
      ...
      <input
        ...
        :state="validation"
        class="form-control"
        placeholder="Введите 10 цифр Вашего телефона или email"
      />
    </div>
...
export default class LoginModal extends Vue {
  ...
  get validation() {
    if (this.user["username"]) {
      ...
      return (this.user.username as string).match(emailPattern) ||
        (this.user.username as string).match(mobilePattern)
        ? true
        : false;
    }
  }
