<template>
  ...
  <b-form-group  :label="data.label" :class="{required: data.required}" label-cols="" :label-class="data.labelCols">
    <date-picker class="sla" v-model="data.value" :disabled="!edit ? !edit : data.readonly" type="date" valueType="DD.MM.YYYY" format="DD.MM.YYYY" :first-day-of-week="1" :lang="lang" :input-class="data.state === false ? `${state} is-invalid` : state" ></date-picker>
