...
export const COMMON_ERROR_MESSAGE = "Что-то пошло не так, попробуйте повторить попытку позже.";
export const SUCCESS_REQUEST_MESSAGE = "Проверка выполнена успешно";
