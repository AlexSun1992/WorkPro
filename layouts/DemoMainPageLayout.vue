            ...
            <div class="container">
                ...
                <div class="buy-block d-flex mt-1_25 justify-content-md-center align-items-center">
                    ...
                    <div class="col-auto pl-0">
                        <b-dropdown text="ОСАГО" class="m-md-2 dpd-link" right>
                    ...
                    <div class="col-auto">
                        <button type="button"
                            class="btn-large btn-arrow-right position-relative uppercase">Расчитать</button>
                    </div>
                </div>
